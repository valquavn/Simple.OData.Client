...
#pragma warning restore CS0649 // Unused private types or members should be removed        {
	...
	public void ToObjectSpatialV3()
	{
		...
		TypeCache.Converter.RegisterTypeConverter(typeof(SpatialV3.GeographyPoint), OData.Client.V3.Adapter.TypeConverters.CreateGeographyPoint);
	...
	public void ToObjectSpatialV4()
	{
		...
		TypeCache.Converter.RegisterTypeConverter(typeof(SpatialV4.GeographyPoint), OData.Client.V4.Adapter.TypeConverters.CreateGeographyPoint);
