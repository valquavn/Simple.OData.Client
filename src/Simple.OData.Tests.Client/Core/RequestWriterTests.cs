...
public class RequestWriterV3Tests : RequestWriterTests
{
	...
	{
		return new OData.Client.V3.Adapter.RequestWriter(_session, await _client.GetMetadataAsync<Microsoft.Data.Edm.IEdmModel>().ConfigureAwait(false), null);
	}
}
...
public class RequestWriterV4Tests : RequestWriterTests
{
	...
	protected async override Task<IRequestWriter> CreateRequestWriter()
	{
		return new OData.Client.V4.Adapter.RequestWriter(_session, await _client.GetMetadataAsync<Microsoft.OData.Edm.IEdmModel>().ConfigureAwait(false), null);
	}
}
